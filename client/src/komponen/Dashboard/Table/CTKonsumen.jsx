...
import CIKonsumen  from "../Finput/CIKonsumen";
...
const CTKonsumen = () => {
  return (
    <div ><meta charSet="UTF-8" />
      ...
      <title>Konsumen Listing Table</title>
          ...
          <table className="w-full table-auto">
            <thead>
              <tr className="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                ...
                <th className="py-3 px-6 text-left">Passwod</th>
            ...
            <tbody className="text-gray-600 text-sm">
              <tr className="border-b border-gray-200 hover:bg-gray-100">
                <td className="py-3 px-6 text-left">KK-01</td>
                <td className="py-3 px-6 text-left">Surasa</td>
                <td className="py-3 px-6 text-left">ayam123</td>
                <td className="py-3 px-6 text-left">Indah Permata no 15</td>
                <td className="py-3 px-6 text-left">Aktif</td>
