...
function CTTimeline() {
  return (
    <div ><meta charSet="UTF-8" />
      ...
      <title>Proyek Timeline Listing Table</title>
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold text-center mb-8"> List Proyek Timeline</h1>
          ...
          <table className="w-full table-auto">
            <thead>
              <tr className="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                ...
                <th className="py-3 px-6 text-left">Konsumen</th>
                <th className="py-3 px-6 text-left">Time Line</th>
                <th className="py-3 px-6 text-center">Actions</th>
              </tr>
            </thead>
            <tbody className="text-gray-600 text-sm">
              <tr className="border-b border-gray-200 hover:bg-gray-100">
                <td className="py-3 px-6 text-left">PTL-01</td>
                <td className="py-3 px-6 text-left">Indah Permata</td>
                <td className="py-3 px-6 text-left">Yayan Ruhiyan</td>
                <td className="py-3 px-6 text-left">Cecep Setiawan</td>
                <td className="py-3 px-6 text-left">Dani Aripin</td>
                <td className="py-3 px-6 text-left">7 Catatan</td>
